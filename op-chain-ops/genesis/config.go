...
func (d *DeployConfig) Check() error {
	...
	if d.L2GenesisCanyonTimeOffset != nil && d.EIP1559DenominatorPostCanyon == 0 {
		return fmt.Errorf("%w: EIP1559DenominatorPostCanyon cannot be 0 if Canyon is activated", ErrInvalidDeployConfig)
	}
